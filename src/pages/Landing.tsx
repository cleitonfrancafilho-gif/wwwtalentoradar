  ...
  const features = [
    {
      icon: Radar,
      title: "DVD Digital",
      desc: "Crie seu portfólio esportivo com vídeos, estatísticas e conquistas.",
    },
    {
      icon: Users,
      title: "Marketplace 3 Lados",
      desc: "Conecte Atletas, Olheiros e Instituições em um só lugar.",
    },
    {
      icon: Shield,
      title: "Segurança Total",
      desc: "Verificação parental, selos de confiança e chat protegido.",
    },
    {
      icon: MapPin,
      title: "Eventos Próximos",
      desc: "Descubra peneiras, torneios e campeonatos perto de você.",
    },
  ];
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto animate-slide-up">
          <div className="inline-flex items-center gap-2 border border-primary/30 rounded-full px-4 py-1.5 mb-8 bg-primary/5">
            ...
            <span className="text-sm text-primary font-display tracking-wider uppercase">
              Plataforma Multiesportiva
            </span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button variant="hero-outline" onClick={() => navigate("/feed")}>
              Explorar Talentos
            </Button>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((f, i) => (
              <div
                key={i}
                className="bg-card border border-border rounded-xl p-6 hover:border-primary/40 transition-all duration-300 group hover:glow-green"
      ...
      <section className="py-20 px-4 text-center">
        ...
        <p className="text-muted-foreground mb-8 max-w-lg mx-auto">
          Junte-se a milhares de atletas, olheiros e instituições que já usam o TalentRadar.
        </p>
        <Button variant="hero" onClick={() => navigate("/cadastro")}>
          Começar Agora
        </Button>
