...
import {
  Radar, Search, Bell, MapPin, Play, Heart, MessageCircle, Calendar, Compass, Flame, TrendingUp,
} from "lucide-react";

const mockTalents = [
  { id: 1, name: "Lucas Silva", age: 16, sport: "Futebol", position: "Atacante", city: "São Paulo, SP", tags: ["#Futebol", "#Sub17", "#Atacante"], likes: 234, comments: 18, score: 95 },
  { id: 2, name: "Ana Oliveira", age: 17, sport: "Vôlei", position: "Levantadora", city: "Rio de Janeiro, RJ", tags: ["#Vôlei", "#Sub18", "#Levantadora"], likes: 189, comments: 12, score: 82 },
  { id: 3, name: "Pedro Santos", age: 15, sport: "Basquete", position: "Pivô", city: "Belo Horizonte, MG", tags: ["#Basquete", "#Sub17", "#Pivô"], likes: 312, comments: 27, score: 91 },
];
